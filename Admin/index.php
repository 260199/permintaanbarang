    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="#" class="logo">
          ...
          <span class="logo-mini"><b>APLIKASI STOK ATK </span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>APLIKASI STOK ATK  </b></span>
        </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <li class="treeview">
            ...
            <li class="treeview">
              <a href="?pg=permintaan&act=view">
                <i class="fa fa-shopping-cart"></i>
                <span>Data Permintaan</span> 
              </a>
            </li>
            <li class="treeview">
              <a href="?pg=lappr&act=view">
      ...
      <footer class="main-footer">
        <div align="center" class="pull-center hidden-xs">
         <b><strong >Mahasiswa Kerja Praktek<br> <a href="http://www.sttpyk.ac.id/y">SEKOLAH TINGGI TEKHNOLOGI PAYAKUMBUH</a></strong></b>
        </div>
